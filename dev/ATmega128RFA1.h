...
#ifndef _DEV_ATmega128RFA1_H_
#define _DEV_ATmega128RFA1_H_
...
const PROGMEM Timer PROGMEM pgm_Timers[] = {
	...
	MAKE_TIMER(__timer2_data,TCNT2,TCCR2B, FALSE, FALSE, TIMER_3BIT_MODES,TCCR2A,WGM20,TCCR2A,WGM21,TCCR2B,WGM22,UNUSED_PORT,0,__timer2Compare, TIMSK2,TOIE2, TIFR2,TOV2, UNUSED_PORT, UNUSED_PORT,0, UNUSED_PORT,0, UNUSED_PORT,0, InputCapture2),
...
const uint8_t NUM_PCINT_PINS = 9;
