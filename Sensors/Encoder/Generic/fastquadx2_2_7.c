/*
 * $Id: fastquadx2_2_7.c,v 1.1 2010/08/10 22:48:51 clivewebster Exp $
 * Revision History
 * ================
 * $Log: fastquadx2_2_7.c,v $
...
#if defined(VECT_INT2) && defined(VECT_INT7)
// Channel A
...
ENCODER_CLASS const c_fastquadx2_INT2_INT7 = MAKE_ENCODER_CLASS(&_init,&__encoder_read,0,0);
