/*
 * $Id: fastquadx2_1_6.c,v 1.1 2010/08/10 22:48:51 clivewebster Exp $
 * Revision History
 * ================
 * $Log: fastquadx2_1_6.c,v $
...
#if defined(VECT_INT1) && defined(VECT_INT6)
// Channel A
...
ENCODER_CLASS const c_fastquadx2_INT1_INT6 = MAKE_ENCODER_CLASS(&_init,&__encoder_read,0,0);
