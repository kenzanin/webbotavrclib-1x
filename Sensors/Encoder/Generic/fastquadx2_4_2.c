/*
 * $Id: fastquadx2_4_2.c,v 1.1 2010/08/10 22:48:51 clivewebster Exp $
 * Revision History
 * ================
 * $Log: fastquadx2_4_2.c,v $
...
#if defined(VECT_INT4) && defined(VECT_INT2)
// Channel A
...
ENCODER_CLASS const c_fastquadx2_INT4_INT2 = MAKE_ENCODER_CLASS(&_init,&__encoder_read,0,0);
