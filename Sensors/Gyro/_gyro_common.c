/*
 * $Id: _gyro_common.c,v 1.4 2010/06/14 19:08:18 clivewebster Exp $
 *
 * Revision History
 * ================
 * $Log: _gyro_common.c,v $
 * Revision 1.4  2010/06/14 19:08:18  clivewebster
 * Add copyright license info
 *
 * Revision 1.3  2009/11/02 18:38:42  clivewebster
 * Added revision log
 *
 * ===========
 *
...
void _gyroDump(const GYRO* device){
	rprintf("(x=%d deg/sec, y=%d deg/sec, z=%d deg/sec)",
