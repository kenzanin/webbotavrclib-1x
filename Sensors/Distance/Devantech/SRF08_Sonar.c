/*
 * $Id: SRF08_Sonar.c,v 1.4 2010/10/01 13:16:26 clivewebster Exp $
 *
 * Revision History
 * ================
 * $Log: SRF08_Sonar.c,v $
 ...
 *
 */
#include "SRF08_Sonar.h"


// Start a new reading
static boolean startReading(const Devantech_SRF08* device){
	boolean rtn = false;
	if(device){
...
DISTANCE_CLASS const c_Devantech_SRF08 = MAKE_DISTANCE_CLASS(null,&__srf08_read,0,70);
