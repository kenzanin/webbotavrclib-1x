...
/* ------------------------------------------------------
 * $Id: atmega328P.h,v 1.4 2010/07/15 14:57:21 clivewebster Exp $
 *
 * Revision History
 * ================
 * $Log: atmega328P.h,v $
 ...
 * Added AVcc_MV
 *
 * Revision 1.3  2009/11/01 00:53:09  clivewebster
 * *** empty log message ***
 *
 ...
 *
 * ===========
 	A generic ATMega 328P configuration
...
#define THE_SYSTEM ATMEGA328P

/*
	We are compiling for the ATMEGA328P
	So we can make certain assumptions: ATMega328P but dot know the frequency
...
#error If including ATMega328P.h you must set the compiler to use the device ATMega328P
#endif
