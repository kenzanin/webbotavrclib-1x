#ifndef _ATMEGA640_H_
#define _ATMEGA640_H_

/* ------------------------------------------------------
 * $Id: atmega640.h,v 1.1 2010/07/19 19:43:00 clivewebster Exp $
 *
 * Revision History
 * ================
 * $Log: atmega640.h,v $
 ...
 *
 * ===========
 	A generic ATMega 640 configuration
...
#define THE_SYSTEM ATMEGA640

/*
	We are compiling for the ATMEGA640
	So we can make certain assumptions: ATMega640 but dot know the frequency
...
#error If including ATMega640.h you must set the compiler to use the device ATMega640
#endif
