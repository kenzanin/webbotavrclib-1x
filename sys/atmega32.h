...
/* ------------------------------------------------------
 * $Id: atmega32.h,v 1.4 2010/07/15 14:57:21 clivewebster Exp $
 *
 * Revision History
 * ================
 * $Log: atmega32.h,v $
 ...
 * Added AVcc_MV
 *
 * Revision 1.3  2009/11/01 00:52:56  clivewebster
 * *** empty log message ***
 *
 ...
 * ===========
	...
	A generic ATMega32 configuration
...
#define THE_SYSTEM ATMEGA32

/*
	We are compiling for the ATMEGA32
	So we can make certain assumptions: ATMega32 but dot know the frequency
...
#error If including ATMega32.h you must set the compiler to use the device ATMega32
#endif
