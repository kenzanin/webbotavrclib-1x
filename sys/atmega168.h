#ifndef _ATMEGA168_H_
#define _ATMEGA168_H_

/* ------------------------------------------------------
 * $Id: atmega168.h,v 1.4 2010/07/15 14:57:21 clivewebster Exp $
 *
 * Revision History
 * ================
 * $Log: atmega168.h,v $
 ...
 * Added AVcc_MV
 *
 * Revision 1.3  2009/11/01 00:52:08  clivewebster
 * *** empty log message ***
 *
...
#error If including ATMega168.h you must set the compiler to use the device ATMega168
#endif
